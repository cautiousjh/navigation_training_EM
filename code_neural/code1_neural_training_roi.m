...
data = cellfun(@(x) x(flag), neural_metric{con_i}{flag_i}, 'uni', 0);
data = data(roi_list);
...
% data_behav = training_behav_em_list{1}; data_behav_cov = training_cov_behav_em_list{1}; is_residual = true; color = COLOR_EM; color_line = [1 .3 .3] ; shade_alpha = 0.15;
% data_behav = training_behav_em_list{4}; data_behav_cov = training_cov_behav_em_list{4}; is_residual = true; color = COLOR_WORD; color_line = [.3 .3 .8] ; shade_alpha = 0.15;
% data_behav = training_behav_em_list{5}; data_behav_cov = training_cov_behav_em_list{5}; is_residual = true; color = COLOR_SPATIAL; color_line = [.3 .8 .3 ];  shade_alpha = 0.23;
% data_behav = training_behav_em_list{4}; data_behav_cov = training_behav_em_list{5}; is_residual = true; color = COLOR_WORD; color_line = [0 0 1];  shade_alpha = 0.15;
% data_behav = training_behav_em_list{5}; data_behav_cov = training_behav_em_list{4}; is_residual = true; color = COLOR_SPATIAL; color_line = [.3 .8 .3 ]; shade_alpha = 0.23;

roi_list = 7; fig_size = [12,8]; 
% roi_list = 115;
% cortical; 1,2,9   113 calcarine 115 lingual
...
%     jh_set_fig(size=[6,6], fontsize=11)
%     ylim([-.6 1.4])
